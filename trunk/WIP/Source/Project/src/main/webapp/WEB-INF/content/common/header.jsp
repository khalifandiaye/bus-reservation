...
<div class="top-nav">
	<div class="top-menu clear-fix" style="color: #ffffff">
		...
		<a id="btn_register" href="<%=request.getContextPath()%>/user/reg01010.html" class="btn btn-mini" style="margin-top:5px;"><s:text name="btn.register" /></a>
		</div>
