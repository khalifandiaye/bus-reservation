...
public abstract class CheckUtils {
    ...
    /**
     * Check if a string is a valid email address<br>
     * 
     * @see <a
     *      href="http://www.regular-expressions.info/email.html">http://www.regular-expressions.info/email.html</a>
     * @param string
     *            the string to be checked
     * @return true if the string is a valid email address
     */
    public static boolean isEmail(String string) {
        return string.toUpperCase().matches(
