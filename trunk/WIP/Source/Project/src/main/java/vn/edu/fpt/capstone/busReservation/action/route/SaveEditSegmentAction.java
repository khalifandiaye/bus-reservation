...
public class SaveEditSegmentAction extends BaseAction {
	...
	private String message = "Route edited successfully!";

	@Action(value = "saveEditSegment", results = { @Result(type = "json", name = SUCCESS, params = {
			"root", "message" }) })
