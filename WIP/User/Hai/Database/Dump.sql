...
INSERT INTO `mail_template` VALUES (1,'userAct','Kích hoạt tài khoản :companyName','<span style=\"color:rgb(255,132,0);font-weight:bold;font-size:16px;text-align:center\" >Kích hoạt tài khoản thành viên Bus Company</span><br />\r\n<br/>\r\nChào :fullName<br/>\r\n<br/>\r\nChúng tôi đã nhận được yêu cầu mở tài khoản thành viên\r\ncủa quý khách tại <a href=\"http://bus-company.com\">bus-company.com</a> với các thông tin sau:<br/>\r\nTên đăng nhập: :username<br/>\r\nTên chủ tài khoản: :fullName<br/>\r\nĐịa chỉ email: :email<br/>\r\n<br/>\r\nĐể hoàn tất quy trình đăng ký, xin quý khách vui lòng nhấn vào đường dẫn bên dưới<br/>\r\nhoặc sao chép vào thanh địa chỉ trên trình duyệt và nhấn Enter:\r\n<a href=\":url\">:url</url>');
...
INSERT INTO `payment` VALUES (1,1114,267000,13500,2,'5N428471PJ208873X','pay'),(2,978,1958000,63000,2,'75E450102T595035F','pay'),(3,994,3128500,96500,2,'62262331793793900','pay'),(4,1052,2088000,66500,2,'8FU216231K928024K','pay'),(5,1075,2088000,66500,2,'16W3143049943410F','pay');
...
-- Dump completed on 2013-03-18  7:20:51
