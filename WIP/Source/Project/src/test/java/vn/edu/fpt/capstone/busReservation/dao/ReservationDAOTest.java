...
public class ReservationDAOTest extends DAOTest {
    ...
    // List<SimpleReservationInfo> beans =
    // reservationDAO.getSimpleReservationInfos("customer1");
    // assertNotNull(beans);
    ...
    public void testGetArrangedReservations001() {
        ReservationDAO reservationDAO = (ReservationDAO) getBean("reservationDAO");
        List<ArrangedReservationBean> beans = reservationDAO
                .getArrangedReservations("customer1");
        assertNotNull(beans);
        // assertEquals(89, beans.size());
        assertNotNull(beans.get(0));
    }
    ...
    public void testGetArrangedReservation001() {
        ReservationDAO reservationDAO = (ReservationDAO) getBean("reservationDAO");
        ArrangedReservationBean bean = reservationDAO
                .getArrangedReservation(971);
        // assertNotNull(bean);
    }
    ...
    // + 1;
    // System.out.println("Forward from " + from + " to " + to + " in " +
    // busStatusBean.getTrips().size());
    ...
    // System.out.println("Return from " + from + " to " + to + " in " +
    // busStatusBean2.getTrips().size());
    // for (int j = from; j < to; j++) {
