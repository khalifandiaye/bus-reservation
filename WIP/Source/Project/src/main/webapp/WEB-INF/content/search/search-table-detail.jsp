...
<td class="cell choose-item"><s:date name="departureTime"
		format="HH:mm" /></td>
...
<td class="cell out-journey-rdo choose-item">
		<input class="hidden" title="Chọn chuyến này" type="checkbox" name="out_journey"
