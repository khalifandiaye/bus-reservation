...
<title>VinaBus - Thông tin đăng kí vé xe</title>
<jsp:include page="../common/xheader.jsp" />
<link href="<%=request.getContextPath()%>/styles/booking.css"
	rel="stylesheet">
<script src="<%=request.getContextPath()%>/js/jquery.validate.min.js"></script>
<script
	src="<%=request.getContextPath()%>/js/booking/booking-validation.js"></script>
...
<body>
	...
	<section>
	<div class="container notify-message"></div>
	</section>
	<!-- End notify message -->
	...
	<div class="well" style="overflow: hidden;">
		<div
			...
			thành thông tin đăng kí vé xe</div>
		<div style="width: 50%; float: left">
			<form class="form-horizontal" action="booking-pay.html" method="post"
				id="booking-form">
				<fieldset>
					<div class="control-group" style="position: relative;">
						<label class="control-label" for="inputFirstName">Tên</label>
						<div class="controls">
							<s:textfield id="inputFirstName" name="inputFirstName"
								placeholder="Tên" maxlength="30"></s:textfield>
							<span
								style="padding-left: 3px; color: red; font-size: 22px; position: absolute; top: 1px; right: 82px;">*</span>
						</div>
					</div>
					<div class="control-group" style="position: relative;">
						<label class="control-label" for="inputLastName">Họ</label>
						<div class="controls">
							<s:textfield id="inputLastName" name="inputLastName"
								placeholder="Họ" maxlength="30"></s:textfield>
							<span
								style="padding-left: 3px; color: red; font-size: 22px; position: absolute; top: 1px; right: 82px;">*</span>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							<s:textfield id="inputMobile" name="inputMobile"
								placeholder="Điện Thoại Di Động" maxlength="11"></s:textfield>
						</div>
					</div>
					<div class="control-group" style="position: relative;">
						<label class="control-label" for="inputEmail">Email</label>
						<div class="controls">
							<s:textfield id="inputEmail" name="inputEmail"
					...
					<table class="listCheckedSeats table " style="width: 315px;">
						<thead>
							<tr>
								<th>Số Ghế</th>
								<th style="text-align: right;"><button type="button"
										class="btn btn-mini btn-danger">Bỏ Ghế</button></th>
							</tr>
						</thead>
						<tbody>
						</tbody>
				...
				<table style="width: 90%">
					...
					<tr>
						<th style="text-align: left"><s:text
								name="resevation.ticketPrice" /></th>
						<td style="text-align: right" id="basePrice"><s:property
								value="reservationInfo.basePrice" /> VND ($<s:property
								value="reservationInfo.basePriceInUSD" />)</td>
					</tr>
					<tr>
						<th style="text-align: left"><s:text
								name="online_transaction_fee" /></th>
						<td style="text-align: right" id="transactionFee"><s:property
								value="reservationInfo.transactionFee" /> VND ($<s:property
								value="reservationInfo.transactionFeeInUSD" />)</td>
					</tr>
					<tr>
						<th style="text-align: left"><s:text
								name="reservation.totalAmount" /></th>
						<td style="text-align: right" id="totalAmount"><s:property
								value="reservationInfo.totalAmount" /> VND ($<s:property
								value="reservationInfo.totalAmountInUSD" />)</td>
					</tr>
				</table>
			</div>
		</div>
